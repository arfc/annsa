...
def load_easy(source_dataset, background_dataset):
    ...
    source_dataset = source_dataset[
        source_dataset['shieldingdensity'] != 13.16]
    source_dataset = source_dataset[
        source_dataset['shieldingdensity'] != 11.02]
...
def load_full(source_dataset, background_dataset):
    ...
    source_dataset = source_dataset[
        source_dataset['shieldingdensity'] != 11.02]
    source_dataset = source_dataset[
        source_dataset['shieldingdensity'] != 1.61]
    ...
    blank_spectra = []
    for fwhm in set(source_dataset['fwhm']):
        num_examples = source_dataset[
            (source_dataset['fwhm'] == fwhm) &
            (source_dataset['isotope'] ==
...
def dataset_to_spectrakeys(dataset):
    ...
    background_spectra = np.array(dataset.item()['backgrounds'],
                                  dtype='float64')
