...
class cnn(tf.keras.Model):
    def __init__(self, model_features):
        ...
        number_filters=model_features.number_filters#(3, 9)
        kernel_size=model_features.kernel_size#(20, 55)
        self.batch_size=model_features.batch_size
        self.scaler=model_features.scaler
...
def load_model(model_folder,model_id,model_class,training_data_length=1024,training_key_length=57):
