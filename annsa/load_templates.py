...
def load_template_spectra_from_folder(parent_folder,spectrum_identifier,normalization=None):
    '''
...
def load_templates(normalization=None):
    ...
    spectral_templates['noshield']=load_template_spectra_from_folder("templates/no-shielding/",
                                                                       spectrum_identifier,normalization)
    ...
    for location in background_locations:
        spectral_templates['background'][location]=normalize_spectrum(location,normalization)
